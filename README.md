...
[![codecov](https://codecov.io/gh/samuelbatista3rios/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/samuelbatista3rios/fastapi-template)
[![CI](https://github.com/samuelbatista3rios/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/samuelbatista3rios/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by samuelbatista3rios

## Install

from source
```bash
git clone https://github.com/samuelbatista3rios/fastapi-template fastapi_template
cd fastapi_template
make install
```
